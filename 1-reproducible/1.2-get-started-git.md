...
On Windows, you can either install Git Bash or use the Anaconda Prompt. On macOS and Ubuntu the Terminal will work fine.
...
We will also configure Git to use a text editor that is easier to use than the normal one:
