...
If you got lost during the workshop, [here](https://swcarpentry.github.io/git-novice/reference) is an extended version of the Git Tutorial you can use later. 
...
![Git workflow through three different changes and with a cloud repository too.](../.gitbook/assets/git101-140304143124-phpapp01-dragged-474.pdf)
...
If you would like to look through a more comprehensive tutorial on Git \(written for software engineers\), this is a great guide: [https://www.atlassian.com/git/tutorials/what-is-version-control](https://www.atlassian.com/git/tutorials/what-is-version-control).
